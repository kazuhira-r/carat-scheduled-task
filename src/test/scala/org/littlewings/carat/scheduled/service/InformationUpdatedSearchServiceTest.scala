...
import org.littlewings.carat.scheduled.test.CdiTestRunnerSupport
import org.mockito.Mockito._

class InformationUpdatedSearchServiceTest extends CdiTestRunnerSupport {
  @Inject
